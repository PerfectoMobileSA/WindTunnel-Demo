...
//			resultSheet.addScreenshotByRowNameAsLink(screenshot, params);
	 ...
	 * @param params A {@link String} array (String[]), with the test name and parameters.
	 */
	protected String reportFailWithMessage(String remarks, String persona, String... params){
    	Reporter.log("Test failed: " + remarks + ".");
    	Reporter.log("Resource name: " + this.deviceDesc + ".");
    	String screenshot = PerfectoUtils.takeScreenshot(driver);
		Reporter.log("Error screenshot saved in file: " + screenshot);
		Reporter.log("<br> <img src=" + screenshot + " style=\"max-width:50%;max-height:50%\" /> <br>");
		try {
			addRowToDetailedSheet(false, screenshot, remarks,persona,params);
//			resultSheet.setResultByColumnName(false, params);
//			resultSheet.addScreenshotByRowNameAsLink(screenshot, params);
			return screenshot;
		} catch (Exception e) {
	...
	protected String reportFailWithMessage2(String remarks,String... params){
    	Reporter.log("Test failed: " + remarks + ".");
    	Reporter.log("Resource name: " + this.deviceDesc + ".");
    	String screenshot = PerfectoUtils.takeScreenshot(driver);
		Reporter.log("Error screenshot saved in file: " + screenshot);
		...
		try {
			...
			addRowToDetailedSheet2(false, screenshot, remarks, params);
//			resultSheet.setResultByColumnName(false, params);
//			resultSheet.addScreenshotByRowNameAsLink(screenshot, params);
			return screenshot;
		} catch (Exception e) {
	 ...
	 * @param params A {@link String} array (String[]), with the test name and parameters.
	 */
	protected void reportPass(String message, String remarks, String... params){
		...
		try {
			...
			addRowToDetailedSheet2(true, screenshot, remarks ,params);
	...
	public void addRowToDetailedSheet(boolean isPassed, String screenshot, String remarks, String persona, String... testParams) throws Exception{
		String params = "";
		...
		testProperties.put("Persona", params);
		testProperties.put("Remarks", remarks);
		detailedResultSheet.addResultsToDetailedSheet(testProperties);
		
	}
	public void addRowToDetailedSheet2(boolean isPassed, String screenshot,String remarks, String... testParams) throws Exception{
		
		String params = "";
		for(String s : testParams){
			String[] val = s.split("=");
			testProperties.put(val[0], val[1]);
			//params += s + ", ";
		}
		//params = params.substring(0, params.lastIndexOf(","));
		String time = PerfectoUtils.getDateAndTimeByFormat("yyyy-MM-dd HH:mm:ss", 0);
		...
		testProperties.put("testCycle", this.testCycle);
		testProperties.put("testResult", testResult);
		/*testProperties.put("expectedLaunch", expectedLaunch);
		testProperties.put("actualLaunch", actualLaunch);
		testProperties.put("expectedNav", expectedNav);
		testProperties.put("actualNav", actualNav);*/
		testProperties.put("screenshot", screenshot);
		/*testProperties.put("Persona", persona);*/
		testProperties.put("Remarks", remarks);
		detailedResultSheet.addResultsToDetailedSheet(testProperties);
